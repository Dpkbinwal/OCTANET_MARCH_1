...
const Achievement = () => {
  return (
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[800px]  px-4 md:px-0'>
            
            <div className='flex flex-col justify-center '>
                <h1 className='md:leading-[72px] text-3xl font-bold'>Our <span className='text-[#45b3e0]'>Achievements</span></h1>
             ...
             <img  src="https://tse2.mm.bing.net/th?id=OIP.eKIBqIDr3tuhpDO7r1VAEQHaE8&pid=Api&P=0&h=220" className="m-auto md:order-last order-first" style={{width: "80%"}}/>
